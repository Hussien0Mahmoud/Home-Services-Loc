          ...
          {/* ماكينات تصليح متطورة */}
              <div className="p-4 md:w-1/4 sm:w-1/2">
                  <div className="px-4 py-6 transform transition duration-500 hover:scale-110">
                      ...
                      <h2 className=" font-regular text-2xl text-gray-900">ماكينات تصليح متطورة</h2>
                  </div>
              </div>
              {/* أسعار تنافسية */}
              <div className="p-4 md:w-1/4 sm:w-1/2">
                  <div className="px-4 py-6 transform transition duration-500 hover:scale-110">
                      ...
                      <h2 className=" font-regular text-2xl text-gray-900">أسعار تنافسية</h2>
                  </div>
              </div>
              ...
              <div className="p-4 md:w-1/4 sm:w-1/2">
                  <div className="px-4 py-6 transform transition duration-500 hover:scale-110">
                      ...
                      <h2 className=" font-regular text-2xl text-gray-900"> التزام بالوقت</h2>
                  </div>
              </div>
              {/* خبرة متخصصة */}
              <div className="p-4 md:w-1/4 sm:w-1/2">
                  <div className="px-4 py-6 transform transition duration-500 hover:scale-110">
                      ...
                      <h2 className=" font-regular text-2xl text-gray-900">خبرة متخصصة</h2>
                  </div>
              </div>
